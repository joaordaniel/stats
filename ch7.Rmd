...
Before we start building the model let’s center our time predictor. The time scores range from 1 to 26. In longitudinal models is a good idea to center time on the first time point (other options include centering on the last time point, or even in the midle point). This way intercepts equal estimated means at time = 0 (our first data point). Use the **Transform > Compute Variable** command to get a time0 variable (just subtract 1 from *time* variable, because here, the lowest value of time is 1).   
