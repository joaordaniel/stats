...
Let’s continue with Lisbon 2011 census but with a different dataset called **lx_2011_house3.sav**. You can download it [here](data/ch6/lx_2011_house3.sav). This dataset has the number of 1 and 2 story buildings (*small_buildings*), and the number o retired residents (*retired_res*) in 500 sub-sections, inserted in 379 sections and 52 Lisbon parishes. Follow the instructions of **figure 6.1** if you may to create the null model.
